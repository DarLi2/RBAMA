...
if __name__ == '__main__':
    ...
    #env = Random_Drowning(env, 0.5)
    e_w =3.56 #the ethical weight
    agent = DRL_agent(env, e_w=e_w)
#
    ## policy training
    episodes = 30000
    agent_name =  env_name + "Epsiodes" + str(episodes) + "wE" + str(e_w)
    agent.train(episodes, agent_name, random_init="positions")
