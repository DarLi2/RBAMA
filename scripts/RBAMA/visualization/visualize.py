...
def main():
    ...
    parser.add_argument('--state_reset', type=str, default=None, help="List of values specifying the positions of the agent and each person on the flattened map, following the pattern: [agent_position, position_person_id_1, position_person_id_2, position_person_id_3, position_person_id_4]")
