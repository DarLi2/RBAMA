...
def main():
    ...
    parser.add_argument('--random_init', type=ast.literal_eval, default="no randomness", help="Random initialization mode (default: 'positions'). Common values: 'no randomness', 'positions'")
